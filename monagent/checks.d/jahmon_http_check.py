...
class HTTPCheck(AgentCheck):
    ...
    def check(self, instance):
        ...
        try:
            ...
            self.gauge('monapi_http_status', 1, tags=tags_list)
            return
        ...
        if response_time:
           ...
           self.gauge('monapi_http_response_time', running_time, tags=tags_rt)
        ...
        self.gauge('monapi_http_status', 0, tags=tags_list)
