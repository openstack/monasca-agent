...
from monagent.common.util import get_os, get_uuid, Timer, get_hostname
from monagent.common.config import get_version, get_system_stats
import system.unix as u
import system.win32 as w32
from agent_metrics import CollectorMetrics
...
class Collector(object):
    ...
    def __init__(self, agentConfig, emitter, systemStats):
    ...
    def _emit(self, payload):
        ...
        if self.continue_running:
            ...
            try:
                self.emitter(payload, log, self.agentConfig)
            except Exception, e:
